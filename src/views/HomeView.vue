        ...
        <div class="z-20 py-bodyY bodySection flex md:px-8 xl:px-28 relative">
          ...
          <div
            ...
            <a :href="$t('etc-grants-dao.apply-now-link')"
              class="text-xl font-bold md:w-1/5 mt-6 md:mx-0 px-5 py-3 rounded text-headingsColor bg-gradient-to-r from-[#ff0000] to-[#581b1b] font-notoSans w-heroButtonMobileWidth  heroButton flex hover:scale-110 transition duration-300 ease-in-out">
