            ...
            <p
              ...
              <div class="inline-block">
                <a 
                  ...
                  class="relative lg:block font-notoSans font-semibold px-5 py-2 rounded text-headingsColor border-2 text-lg topApplyNow bg-gradient-to-r from-[#d92626] to-[#ff0606]">
