<template>
  ...
  <nav
  class="z-40 sticky pl-8 pr-6 xl:px-40 py-navMobile md:py-8 text-headingsColor top-0 bg-background w-fullWidth border-b-2 lg:border-b-0 border-footerBorder"
  ref="navBar">
