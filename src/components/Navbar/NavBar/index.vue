<template>
    ...
    <div class="flex items-center justify-between header-wrapper">
      ...
      <div class="items-end float-right lg:space-x-4 xl:space-x-8 flex text-lg">
        ...
        <a :href="$t('etc-grants-dao.apply-now-link')"
          class="relative hidden lg:block font-notoSans font-semibold px-5 py-2 rounded text-headingsColor border-2 text-lg topApplyNow bg-gradient-to-r from-[#d92626] to-[#133706]">
  ...
  <div
    ...
    <!-- Mobile navigation -->
    <a :href="$t('etc-grants-dao.apply-now-link')"
      class="py-1 mt-11 text-black text-center bg-gradient-to-r from-[#d92626] to-[#133706] font-notoSans text-base font-bold rounded">
